...
class AmcController extends Controller
{
  public function __construct()
    ...
    {
      $amcs = Amc::with('account', 'item')->orderBy('id', 'desc')->paginate(1000);
    ...
    public function amc_datatable()
    {
      ...
      // Pass the data to the view
      return view('entery.amclist_datatable', [
          'amcs' => $amcs,
          'columns' => $columns,
      ]);
      ...
      if($validator->passes())
        {
          ...
          return redirect('amclist_end_month');
        }    
        else{
          return redirect('/amcform')->withInput()->withErrors($validator);
