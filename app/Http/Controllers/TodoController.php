...
class TodoController extends Controller
{
    ...
    public function quotation(){
        ...
        return view('callmanagement.quotation',compact('comppic','compinfofooter','componyinfo'));
    }
...
//     $pdf = Pdf::loadView('callmanagement.quotation', compact('comppic', 'compinfofooter', 'componyinfo'));

//     // Option 1: Download directly
//     return $pdf->download('quotation.pdf');

//     // Option 2: Show in browser (remove download line above if you want this)
...
// }
    ...
    public function index_done()
    {
        ...
        public function todolist_report($report_value)
    {

        $record = Todo::where('reminder_title', '=', $report_value)
        ->where('reminder_af1','0')
        ->get();
        // $record = Todo::query()->where('reminder_af1', '=', '1')->get();
          // $record=todo::all();
        return view('callmanagement.todolist',['data'=>$record]);
