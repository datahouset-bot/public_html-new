 ...
 class TestController extends Controller
{
    ...
    public function searchbox(Request $request)
    {
        if ($request->ajax()) {
            ...
            // Perform your search based on the $account_name value
    
            // For demonstration, let's assume the search is successful and return a JSON response
            return response()->json(['res' => 'Search successful for ' . $account_name]);
        } else {
