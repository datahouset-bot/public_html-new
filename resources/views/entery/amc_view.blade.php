...
<body>
    ...
    <button id="print" onclick="printInvoice()">Print</button>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td width="10%">8523</td>
                <td width="10%">1</td>
                <td width="10%" class="fw-bold">Pcs</td>
                <td width="10%" class="fw-bold">{{ $amc['amc_amount'] }}</td>
 
                <td width="10%" class="fw-bold">{{ $amc['amc_amount'] }}</td>
            </tr>
            <tr>
                <td colspan="6" class="total-heading">Total Amount in &nbsp;{{ $compinfofooter->currency }} - <small>Inc. all vat/tax</small> :</td>
