...
{{-- <script>
  $(document).ready(function () {
    ...
    <div class="container-fluid my-1">
       <div class="row text-center"><h3>Month Wise Amc END List </h3></div>
       <div class="row justify-content-center align-items-center">
       
       
       
        {{-- <div class=" d-flex align-items-center justify-content-center col-md-6 "> --}}
          <form action={{url('/amclist_end_month')}} method="POST">
                    <div class="col-md-12 text-center">
                            @csrf
                                 
                       
                            
                            {{-- <select name="month" class="myitem" id="month">
                          ...
                          <a href={{url('/amclist_due_month')}} class="btn btn-warning" ><i class="fa fa-refresh" style="font-size:20px;color:black"></i> </a>
            ...
            <table  id="recordtable" class="table table-striped table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td scope="col">{{ $amc->account->mobile }}</td>
                        <td scope="col">{{ $amc->remark1 }}</td>
                        <td scope="col">{{ $amc->remark2 }}</td>
                   ...
                   @php
                   $startDateTime = \Carbon\Carbon::now()->addHours(0)->addMinutes(1);
                ...
                $diffInDays = $startDateTime->diffInDays($endDateTime, false);
               ...
               <td scope="col">{{ $diffInDays }}</td>
                      ...
                      <td>
                    <a href="https://wa.me/91{{ $amc->account->mobile }}" >
