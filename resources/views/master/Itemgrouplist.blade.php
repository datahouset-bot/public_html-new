            ...
            <table class="table table-striped" id="remindtable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{('showediteditemgroups/'.$record['id']) }}"  class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#myModal">Edit</a></td>
                    <td><a href="{{('deleteitemgroups/'.$record['id']) }}"  class="btn btn-danger btn-sm">Delete</a></td>
                  </tr>
                  @endforeach
