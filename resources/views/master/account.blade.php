            ...
            <table class="table table-striped" id="remindtable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$record['gst_no']}}</td>
                    <td><a href="{{('accountformview/'.$record['id']) }}"  class="btn btn-info btn-sm">View</a></td>
                    <td><a href="{{('showeditaccount/'.$record['id']) }}"  class="btn btn-primary btn-sm">Edit</a></td>
                    <td><a href="{{('deleteaccount/'.$record['id']) }}"  class="btn btn-danger btn-sm">Delete</a></td>
                  </tr>
                  @endforeach
