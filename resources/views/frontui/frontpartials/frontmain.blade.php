            ...
            <div class="container">
                <div class="row">
                    <div class="hidden-xs col-lg-7 col-sm-5 top-info">
                        ...
                        <span class="hidden-sm"><i class="fa fa-envelope"></i>Email: Datahousetechnology@gmail.com</span>
                    </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="widget_content">
                    ...
                    <ul class="contact-details-alt">
                        ...
                        <li><i class="fa fa-envelope"></i> <p><strong>Email</strong>: <a href="#">Datahousejbp@gmail.com</a></p></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3">
